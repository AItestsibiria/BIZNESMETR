...
export const MUZA_TOOLS: ToolDef[] = [
  ...
  // плейлистом и треками»). Доступны и admin'у и обычному юзеру — это
  // user-facing feature. Handler возвращает строку с marker
  // [PLAYER_ACTION:type:payload] — frontend парсит и эмитит CustomEvent
  // 'muza-player-action' который слушают landing.tsx / dashboard.tsx.
  {
    name: "play_track",
