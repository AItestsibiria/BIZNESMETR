...
export function FloatingConsultant() {
  ...
  const musicFactsRef = useRef([
    ...
    { id: "fact_suno_speed", emoji: "⚡", text: "MuzaAi пишет трек за минуту — раньше нужны были дни", expand: "Расскажи как MuzaAi ускорил создание музыки и предложи крутой трек" },
            ...
            <div className="grid grid-cols-[1fr_auto] gap-2 mt-3">
              ...
              <button
                ...
                onClick={() => {
                  // На 15 минут
                  try {
                    const untilTs = Date.now() + 15 * 60 * 1000;
                    localStorage.setItem("muza-dismiss-until-ts", String(untilTs));
