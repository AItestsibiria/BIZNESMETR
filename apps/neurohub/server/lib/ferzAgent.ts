...
// Возраст «протух» для lastSeenAt агента (Eugene 2026-05-30: 12ч → 24ч —
// большинство голосовых/админских агентов по дизайну молчат при отсутствии
// действий юзера; 12ч давало много false positive).
