...
### Speed-proportional-tokens rule (Eugene 2026-05-30)

**Скорость пропорциональна токенам.** Чем быстрее Боссу нужен результат — тем больше параллелизма и субагентов.
